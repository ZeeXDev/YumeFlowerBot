...
async def show_bots_list(message_or_callback, bots: list, page: int = 0, per_page: int = 5):
    ...
    text = f"<b>📋 Liste des Bots Clonés</b>\n\n"
    text += f"<b>Total:</b> {total_bots} bot(s) | <b>Page:</b> {page + 1}/{total_pages}\n\n"
    ...
    if page < total_pages - 1:
        nav_buttons.append(InlineKeyboardButton("Suivant ▶️", callback_data=f"list_page_{page+1}"))
